/**
 * Business Helper — In-App Help Center & FAQ Engine (CommonJS for Test Runner)
 */
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: 'La facturación electrónica SAT CFDI 4.0 está disponible en todos los planes como add-on por folio o con folios mensuales incluidos (10 en Negocio, 50 en Empresa). Puedes timbrar en 1 clic tus cotizaciones aceptadas o pagos confirmados. Garantía de Seguridad: Nunca almacenamos tus certificados SAT (.cer/.key); mantienes el control total de tus llaves con tu PAC de confianza.',
    tags: ['sat', 'cfdi', 'factura', 'facturapi', 'xml', 'pdf', '4.0', 'add-on', 'folio', 'cer', 'key']
  },
  {
    id: 'fac-2',
    category: 'facturacion',
...
const CATEGORIES = [
  ...
  { id: 'cobranza', label: 'Cobranza & SPEI', icon: 'DollarSign' },
  { id: 'facturacion', label: 'Facturación SAT', icon: 'FileCode' },
  { id: 'cuenta', label: 'Mi Cuenta', icon: 'Settings' }
];

function searchFAQItems(query = '', category = 'todas') {
...
function generateWhatsAppSupportLink(userMessage = '') {
