...
export const APP_TIERS: TierConfig[] = [
  ...
  },
  {
    ...
    features: [
      ...
      'Facturación electrónica SAT CFDI 4.0 (1-Clic)',
  ...
  },
  {
    ...
    priceMonthly: 1499,
    description: 'Para empresas consolidadas con equipo comercial, múltiples sucursales y control RBAC.',
    targetAudience: 'Usuarios ilimitados • Multi-sucursal',
    features: [
      'Todo lo del Plan Pro +',
      'Roles de usuario y permisos RBAC (Owner, Manager, Contador)',
      'Multi-sucursal y multi-RFC',
      'Control de inventario e historial de stock',
      'Conexión API personalizada y Webhooks',
      'Atención prioritaria VIP 24/7 y Onboarding dedicado',
    ],
