/**
 * Business Helper — Dashboard Financial Analytics & Cash Flow Calculator (JS export for test-runner)
 */

function calculateBusinessMetrics(milestones = [], quotes = [], clients = [], todayStr) {
...
function getTopClientsByRevenue(milestones = [], clients = [], topN = 5) {
...
function calculateCashFlowForecast(milestones = [], referenceDateStr) {
