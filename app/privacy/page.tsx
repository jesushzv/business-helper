      ...
      <main className="max-w-4xl mx-auto px-4 py-12 space-y-8">
        ...
        <section className="space-y-6 text-slate-300 text-sm leading-relaxed sm:text-base">
          <div className="bg-slate-900/60 border border-slate-800 rounded-2xl p-6 space-y-4">
            ...
            <p>
              <strong>Business Helper S.A.P.I. de C.V.</strong> (en lo sucesivo &quot;Business Helper&quot;), con domicilio en Monterrey, Nuevo León, México, es el responsable del tratamiento y protección de sus datos personales y financieros recolectados a través de nuestra plataforma web y aplicación móvil.
            </p>
          </div>
