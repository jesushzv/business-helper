...
const PRICING_PLANS = [
  {
    ...
    description: 'Ideal para microempresas y consultores independientes.',
    price: '$299',
    period: 'MXN / mes',
    featured: false,
    badge: 'Cobranza Básica',
    features: [
      'Hasta 30 cotizaciones al mes',
      'Facturación CFDI 4.0 ilimitada (Facturapi)',
  ...
  },
  {
    id: 'pro',
    name: 'Plan PyME Pro',
    description: 'Para empresas en crecimiento con equipo comercial y de cobranza.',
    price: '$599',
    period: 'MXN / mes',
    featured: true,
    ...
    features: [
      ...
      'Facturación CFDI 4.0 ilimitada con Timbrado PAC',
      'Conciliación automática SPEI Banxico',
      'Firma legal OTP SHA-256 certificada',
      'Reportes de cartera vencida & scoring de clientes',
  ...
  {
    id: 'business',
    name: 'Plan Empresarial / Multi-sucursal',
    description: 'Para negocios consolidados con múltiples vendedores o sucursales.',
    price: '$1,199',
    period: 'MXN / mes',
    featured: false,
    ...
    features: [
      ...
      'Acceso multi-tenant y roles avanzados',
      'Exportación automática ZIP para contador',
