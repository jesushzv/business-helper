...
import { satRegimenOptions } from '@/lib/satRegimenes';
...
function RegisterFormContent() {
  ...
  const handleGoogleRegister = async () => {
    ...
    try {
      ...
      if (authError) {
        setError('No se pudo registrar con Google. Intenta completando el formulario.');
      }
    } catch {
          ...
          <div className="mb-6">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-slate-900 px-3 text-slate-400 font-medium">o completa tus datos</span>
              </div>
            </div>
          </div>
          )}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 pt-1">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  >
                    {satRegimenOptions(taxRegime).map((r) => (
