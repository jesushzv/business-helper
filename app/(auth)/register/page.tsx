    ...
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-xl z-10 px-4">
        <div className="bg-slate-900/90 backdrop-blur-xl py-8 px-6 shadow-2xl rounded-3xl border border-slate-800 sm:px-10">
          ...
          <GoogleAuthButton
            dividerLabel="o completa tus datos"
            unavailableMessage="Por ahora no es posible registrarte con Google. Completa el formulario para crear tu cuenta."
            failureMessage="No se pudo registrar con Google. Intenta completando el formulario."
            resolveNext={() => safeInternalPath(searchParams.get('next'))}
            onError={setError}
          />
