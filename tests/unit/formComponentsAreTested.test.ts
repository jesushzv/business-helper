 ...
 * Nine such components have no test that renders them and are allowlisted
 * below, tracked in #149 — among them `QuoteWizardModal`, `OtpSignatureModal`
 * and `/pay/[token]`, which is to say most of the Quote → Contract → Pay loop
 * and the page a paying client sees.
 *
...
const UNTESTED = new Set([
  ...
  'components/quotes/QuoteWizardModal.tsx',
