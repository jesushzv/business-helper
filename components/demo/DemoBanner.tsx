...
export const DemoBanner: React.FC<DemoBannerProps> = ({ onOpenTierModal }) => {
  return (
    <div className="sticky top-0 z-50 w-full bg-linear-to-r from-emerald-950 via-slate-900 to-indigo-950 border-b border-emerald-500/30 px-4 py-2.5 shadow-lg backdrop-blur-md">
