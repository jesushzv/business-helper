...
|:---|:---|:---|
| Test suite | 182/182 via `scripts/test-runner.js` | **1411 tests / 154 files**, `npx vitest run` (2026-08-11, this branch merged with `main` @ `ab98a94`) — runner file no longer exists |
