...
| Metric | State |
|:---|:---|
| Test suite | **2027 tests / 190 files**, `npx vitest run` on the deletion-semantics branch cut from `main` (2026-08-14). The `scripts/test-runner.js` that reported "182/182" no longer exists |
