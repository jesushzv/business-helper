...
> [!NOTE]
> **Most remaining rows need the founder.** Rows 1–4 and 7 are credentials, accounts, a real
> handset and a real card; rows 5, 6 and 8 are code waiting on a pass through a real deployment.
