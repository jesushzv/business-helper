...
| **Facturapi** | SAT CFDI 4.0 PAC Electronic Invoicing | `facturapi` | `FACTURAPI_SECRET_KEY` | Queue failed invoice requests; return `cfdi_status: 'failed'` with retry trigger |
